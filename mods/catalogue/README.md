...
## MC Harmony Home 2026Reset

本构建面向 Minecraft 1.21.1 / NeoForge 21.1.235。Catalogue 会将 NeoForge 原版模组列表替换为可搜索的目录，方便查看模组信息、网页链接、BUG 提交入口、筛选、收藏与更新状态。

- 加载侧：仅客户端。专用服务器不需要安装。
- 本次调整：补齐简体中文界面；关闭配置与图片读取流，避免浏览大量模组图标后累积文件句柄。
- 上游许可证：MIT，原作者为 MrCrayfish。
- 2026Reset 的构建、审查与发布说明见 [MC Harmony Home](https://github.com/kirito0000001/MC-Harmony-Home/tree/main/mods/catalogue)。

[直接下载 Catalogue 1.11.2-2026Reset](https://github.com/kirito0000001/MC-Harmony-Home/releases/download/catalogue-1.11.2-2026Reset/catalogue-neoforge-1.21.1-1.11.2-2026Reset.jar)
